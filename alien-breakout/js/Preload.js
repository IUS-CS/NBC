...
InfiniteScroller.Preload.prototype = {
  preload: function() {
    ...
    //load game assets
    this.load.spritesheet('dog', 'assets/images/manrun.png', 115.5, 155, 4);
    this.load.image('playerScratch', 'assets/images/manjump.png');
    ...
    this.load.image('flea', 'assets/images/red-square.png');
